...
Page( {
  data: {
    ...
    avatarUrl: '/images/logo.jpg', //当前开发者头像
    nickName: '博琨', //当前开发者名字
...
//   });
  ...
  onReady: function() {
    ...
    //获取圈子列表
    requests.getCircleList(( data ) => {
      _this.setData( { themeData: data.data.list });
    });
  },
  ...
  toThemePage: function (e) {
    ...
    console.log('themeId', _this.data.themeId);
    requests.getCricleArticles(_this.data.themeId, (data) => {
      console.log(data);
      _this.setData({
        pageData: data.data.list
      });
